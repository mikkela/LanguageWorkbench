...
class ScannerTest extends munit.FunSuite{
  ...
  test("Scan for Operators") {
    ...
    assertEquals(iterator.next(), NameToken("shape", createSourcePosition(1, 41)))
    assertEquals(iterator.next(), QuoteToken(createSourcePosition(1, 46)))
    assertEquals(iterator.next(), NameToken("restruct", createSourcePosition(1, 47)))
    ...
    assertEquals(iterator.next(), ConsToken(createSourcePosition(1, 106)))
    assertEquals(iterator.next(), CarToken(createSourcePosition(1, 111)))
    assertEquals(iterator.next(), CdrToken(createSourcePosition(1, 115)))
    assertEquals(iterator.next(), NumberQuestionToken(createSourcePosition(1, 119)))
    assertEquals(iterator.next(), SymbolQuestionToken(createSourcePosition(1, 127)))
    assertEquals(iterator.next(), ListQuestionToken(createSourcePosition(1, 135)))
    assertEquals(iterator.next(), NullQuestionToken(createSourcePosition(1, 141)))
    assertEquals(iterator.next(), PrimopQuestionToken(createSourcePosition(1, 147)))
    assertEquals(iterator.next(), ClosureQuestionToken(createSourcePosition(1, 155)))
    assertEquals(iterator.next(), EndOfFileToken)
    assertEquals(iterator.hasNext, false)
  }
  ...
  test("Scan for keywords") {
    ...
    assertEquals(iterator.next(), LambdaToken(createSourcePosition(1, 27)))
