...
class ScannerTest extends munit.FunSuite{
  ...
  test("Scan for punctuators") {
    ...
    assertEquals(iterator.next(), QuoteToken(createSourcePosition(1, 3)))
    assertEquals(iterator.next(), NameToken("$#", createSourcePosition(1, 4)))
    assertEquals(iterator.next(), EndOfFileToken)
    assertEquals(iterator.hasNext, false)
  }
  ...
  test("Scan for Operators") {
    ...
    assertEquals(iterator.next(), PlusToken(createSourcePosition(1, 1)))
    assertEquals(iterator.next(), MinusToken(createSourcePosition(1, 3)))
    assertEquals(iterator.next(), StarToken(createSourcePosition(1, 5)))
    assertEquals(iterator.next(), SlashToken(createSourcePosition(1, 7)))
    assertEquals(iterator.next(), LeftParenthesisToken(createSourcePosition(1, 8)))
    assertEquals(iterator.next(), EqualToken(createSourcePosition(1, 9)))
    assertEquals(iterator.next(), LessToken(createSourcePosition(1, 11)))
    assertEquals(iterator.next(), GreaterToken(createSourcePosition(1, 13)))
    assertEquals(iterator.next(), PrintToken(createSourcePosition(1, 15)))
    assertEquals(iterator.next(), MaxToken(createSourcePosition(1, 21)))
    assertEquals(iterator.next(), OrToken(createSourcePosition(1, 25)))
    assertEquals(iterator.next(), RightParenthesisToken(createSourcePosition(1, 27)))
    assertEquals(iterator.next(), AndToken(createSourcePosition(1, 28)))
    assertEquals(iterator.next(), CompressToken(createSourcePosition(1, 32)))
    assertEquals(iterator.next(), ShapeToken(createSourcePosition(1, 41)))
    assertEquals(iterator.next(), QuoteToken(createSourcePosition(1, 46)))
    assertEquals(iterator.next(), RestructToken(createSourcePosition(1, 47)))
    assertEquals(iterator.next(), IndxToken(createSourcePosition(1, 56)))
    assertEquals(iterator.next(), TransToken(createSourcePosition(1, 61)))
    assertEquals(iterator.next(), RavelToken(createSourcePosition(1, 67)))
    assertEquals(iterator.next(), LeftSquareBracketRightSquareBracketToken(createSourcePosition(1, 73)))
    assertEquals(iterator.next(), PlusSlashToken(createSourcePosition(1, 76)))
    assertEquals(iterator.next(), MinusSlashToken(createSourcePosition(1, 79)))
    assertEquals(iterator.next(), StarSlashToken(createSourcePosition(1, 82)))
    assertEquals(iterator.next(), SlashSlashToken(createSourcePosition(1, 85)))
    assertEquals(iterator.next(), MaxSlashToken(createSourcePosition(1, 88)))
    assertEquals(iterator.next(), OrSlashToken(createSourcePosition(1, 93)))
    assertEquals(iterator.next(), AndSlashToken(createSourcePosition(1, 97)))
    assertEquals(iterator.next(), CatToken(createSourcePosition(1, 102)))
  ...
  test("Scan for keywords") {
    ...
    assertEquals(iterator.next(), DefineToken(createSourcePosition(1, 1)))
    assertEquals(iterator.next(), IfToken(createSourcePosition(1, 8)))
    assertEquals(iterator.next(), WhileToken(createSourcePosition(1, 11)))
    assertEquals(iterator.next(), BeginToken(createSourcePosition(1, 17)))
    assertEquals(iterator.next(), SetToken(createSourcePosition(1, 23)))
    ...
    assertEquals(iterator.next(), NameToken("infer", createSourcePosition(1, 52)))
    assertEquals(iterator.next(), NameToken("from", createSourcePosition(1, 58)))
    assertEquals(iterator.next(), NameToken("infer?", createSourcePosition(1, 63)))
    assertEquals(iterator.next(), EndOfFileToken)
    assertEquals(iterator.hasNext, false)
  }
}
